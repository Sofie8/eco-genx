...
<style>
  /* =======================================================
     Home page — relies on global assets/css/site.css
     ======================================================= */
  ...
  /* ---------- Meetbaar bewijs CTA (donkergroen, leesbaar) ---------- */
  .cta-proof{
    border-radius: 22px;
    padding: 1.65rem 1.65rem;
    background: linear-gradient(180deg, rgba(11,59,47,.96), rgba(8,42,34,.96));
  ...
  .cta-proof .section-intro{
    opacity: .9;
    color: rgba(255,255,255,.88);
  }

  /* ---------- Certified block (Home) — 2x2 grid zoals voorbeeld ---------- */
  .cert-wrap{
    position: relative;
    left: 50%;
    right: 50%;
...
<!-- CERTIFIED 2x2 BLOCK (full-bleed) -->
<section class="cert-wrap" aria-label="Gecertificeerde kwaliteit">
  <div class="cert-grid">
    ...
    <div class="cert-cell cert-text">
      ...
      <a class="cert-link" href="{{ '/certificaten/' | relative_url }}">Ga naar certificaten →</a>
    </div>
