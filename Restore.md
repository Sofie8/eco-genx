...
<style>
  /* ---------------------------------------------------------
     Restore page — Full width sections + keeps service pills
     Scoped to .svc-restore so it won't mess other pages
     --------------------------------------------------------- */

  /* Force this page content full width (your theme wraps markdown) */
  main{
  ...
  /* Put the pills over the hero (right top) */
  .svc-restore .service-topbar{
    position: absolute;
    top: 1.05rem;
    right: 1.25rem;
    z-index: 5;
  ...
  .svc-restore .hero{
    ...
    padding: 4.6rem 0 3.2rem; /* extra top for pills */
  }
...
<div class="svc-restore">
  ...
  <div class="service-topbar">
    <div class="service-pills">
      <a class="is-active" href="{{ '/restore/' | relative_url }}">Restore</a>
      <a href="{{ '/microproof/' | relative_url }}">MicroProof</a>
  ...
  <section class="block">
    ...
    <div class="text">
      ...
      <p class="lead">
        Om te bewijzen dat de biologische motor effectief draait en de sanering duurzaam is, hanteren wij een
